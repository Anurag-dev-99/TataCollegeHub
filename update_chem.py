...
new_json_entries = """    },
    {
        "id": "pyq-mn-chem-sem1-2025",
        "category": "Minor",
        "semester": 1,
        "subject": "Chemistry",
        "title": "Chemistry Minor Sem 1 PYQ 2025 Batch",
        "year": "2024-2028",
        "downloadUrl": "https://drive.google.com/file/d/1SYRWspE9RpfXCgJ3LrFzBLsA-cBV-Zyi/view?usp=drive_link",
        "fileSize": "PDF File",
        "downloadCount": 0
    }
]"""
...
c_pyqs = c_pyqs.replace('padding: 1px 5px;">39<', 'padding: 1px 5px;">40<')
old_end = "s:'Sem 1'}].map"
new_end = "s:'Sem 1'},{e:'🧪',t:'Chemistry Minor PYQ',s:'Sem 1'}].map"
...
c_idx = c_idx.replace("42 Tasks Resolved", "43 Tasks Resolved")

insertion = "<!-- Psychology Major PYQ -->"
new_rows = """<!-- Chemistry Minor PYQ -->
        <div style="display: grid; grid-template-columns: 1fr auto; gap: 0.5rem; align-items: center; padding: 0.6rem 0.6rem; border-radius: var(--radius-xs); transition: background 0.15s;" class="req-row">
          <div style="display: flex; align-items: center; gap: 0.6rem; min-width: 0;">
            ...
            <div>
              <span style="font-size: 0.85rem; font-weight: 700; color: var(--text-primary);">Chemistry Minor PYQ</span>
