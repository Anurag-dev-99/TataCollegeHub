...
new_json_entries = """    },
    {
        "id": "pyq-mdc-geo-sem1-2025",
        "category": "MDC",
        "semester": 1,
        "subject": "Geography",
        "title": "Geography MDC Sem 1 PYQ 2025 Batch",
        "year": "2024-2028",
        "downloadUrl": "https://drive.google.com/file/d/17h2A3NRblEqGvEqEXUbGFbIfd_cVaeLj/view?usp=drive_link",
        "fileSize": "PDF File",
        "downloadCount": 0
    }
]"""
...
c_pyqs = c_pyqs.replace('padding: 1px 5px;">40<', 'padding: 1px 5px;">41<')
old_end = "s:'Sem 1'}].map"
new_end = "s:'Sem 1'},{e:'🌍',t:'MDC Geography PYQ',s:'Sem 1'}].map"
...
c_idx = c_idx.replace("43 Tasks Resolved", "44 Tasks Resolved")

insertion = "<!-- Psychology Major PYQ -->"
new_rows = """<!-- Geography MDC PYQ -->
        <div style="display: grid; grid-template-columns: 1fr auto; gap: 0.5rem; align-items: center; padding: 0.6rem 0.6rem; border-radius: var(--radius-xs); transition: background 0.15s;" class="req-row">
          <div style="display: flex; align-items: center; gap: 0.6rem; min-width: 0;">
            ...
            <div>
              <span style="font-size: 0.85rem; font-weight: 700; color: var(--text-primary);">Geography MDC PYQ</span>
