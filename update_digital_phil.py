...
new_json_entries = """    },
    {
        "id": "pyq-sec-digind-sem1-2025-set1",
        "category": "SEC",
        "semester": 1,
        "subject": "Digital India",
        "title": "Digital India SEC Sem 1 PYQ 2025 Batch (Set 1)",
        "year": "2024-2028",
        "downloadUrl": "https://drive.google.com/file/d/1yDdIEJ78vAeLHFnQ9cZHReeJVshN355c/view?usp=drive_link",
        "fileSize": "PDF File",
        "downloadCount": 0
    },
    {
        "id": "pyq-mdc-phil-sem1-2025",
        "category": "MDC",
        "semester": 1,
        "subject": "Philosophy",
        "title": "Philosophy MDC Sem 1 PYQ 2025 Batch",
        "year": "2024-2028",
        "downloadUrl": "https://drive.google.com/file/d/1kzVBtA1jdZlEKqj2ldYZvhSnfMinpyLk/view?usp=drive_link",
        "fileSize": "PDF File",
        "downloadCount": 0
    }
]"""
...
c_pyqs = c_pyqs.replace('padding: 1px 5px;">42<', 'padding: 1px 5px;">44<')
old_end = "s:'Sem 1'}].map"
new_end = "s:'Sem 1'},{e:'📱',t:'SEC Digital India PYQ',s:'Sem 1 (Set 1)'},{e:'🧠',t:'MDC Philosophy PYQ',s:'Sem 1 (2025)'}].map"
...
c_idx = c_idx.replace("45 Tasks Resolved", "47 Tasks Resolved")

insertion = "<!-- Psychology Major PYQ -->"
new_rows = """<!-- Digital India SEC PYQ -->
        <div style="display: grid; grid-template-columns: 1fr auto; gap: 0.5rem; align-items: center; padding: 0.6rem 0.6rem; border-radius: var(--radius-xs); transition: background 0.15s;" class="req-row">
          <div style="display: flex; align-items: center; gap: 0.6rem; min-width: 0;">
            ...
            <div>
              <span style="font-size: 0.85rem; font-weight: 700; color: var(--text-primary);">SEC Digital India PYQ (Set 1)</span>
              <span style="font-size: 0.72rem; color: var(--text-tertiary); margin-left: 0.4rem;">Sem 1</span>
            </div>
          </div>
          <span style="font-size: 0.72rem; color: var(--text-secondary); white-space: nowrap; text-align: right;">22 Jul &rarr; <strong style="color: var(--accent-success);">22 Jul</strong></span>
        </div>

        <div style="height: 1px; background: var(--border-color); margin: 0 0.2rem; opacity: 0.5;"></div>

        <!-- Philosophy MDC PYQ 2025 -->
        <div style="display: grid; grid-template-columns: 1fr auto; gap: 0.5rem; align-items: center; padding: 0.6rem 0.6rem; border-radius: var(--radius-xs); transition: background 0.15s;" class="req-row">
          <div style="display: flex; align-items: center; gap: 0.6rem; min-width: 0;">
            <span style="font-size: 0.75rem; flex-shrink: 0;">🧠</span>
            <div>
              <span style="font-size: 0.85rem; font-weight: 700; color: var(--text-primary);">Philosophy MDC PYQ (2025)</span>
              <span style="font-size: 0.72rem; color: var(--text-tertiary); margin-left: 0.4rem;">Sem 1</span>
            </div>
          </div>
          <span style="font-size: 0.72rem; color: var(--text-secondary); white-space: nowrap; text-align: right;">22 Jul &rarr; <strong style="color: var(--accent-success);">22 Jul</strong></span>
